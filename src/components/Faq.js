        ...
        <div className="flex flex-wrap justify-center mt-20 font-Inter">
          ...
          <div className="md:w-5/12 m-4">
            ...
            <p className="text-lg text-gray-700">
              ...
              <span className="font-semibold">custom</span> in icon section and you can upload your own logo to
              personalize your cover images.
            </p>
          ...
          <div className="md:w-5/12 m-4">
            ...
            <p className="text-lg text-gray-700">
              Yes! Why not? Even though coverview was built with technical blogs in mind, you can still use it for your
              personal blogs. Check out the stylish theme for more.
            </p>
          </div>
