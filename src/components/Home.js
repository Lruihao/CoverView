      ...
      <div className="md:my-32  my-10 mx-auto">
          ...
          <div className="flex md:flex-row flex-col mx-auto justify-center my-10">
            ...
            <div className="m-10 p-10 bg-white rounded-xl shadow-xl shadow-gray-100 flex  flex-col  md:w-4/12 ">
              ...
              <p className="text-2xl md:text-left text-center text-gray-700">
                ...
                <span className="font-bold">higher conversion rate</span> than a random stock image.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-8/12 mx-auto pt-24 p-4">
          ...
          <Link to="/editor">
            <button
              type="button"
              className="flex mx-auto my-4 hover:translate-x-2 duration-300 bg-gray-700  rounded-full px-6 text-white text-xl font-Inter font-semibold p-4"
            >
      ...
      <footer className="bg-white p-10 flex md:flex-row flex-col font-Inter md:px-20 md:gap-20 justify-center items-center">
        <div className="md:w-1/2 flex flex-col">
          <span className="text-lg">
            Made with 💛 by
            <a href="https://github.com/Lruihao" className="font-semibold" target="_blank" rel="noreferrer">
              Lruihao
            </a>
          </span>
