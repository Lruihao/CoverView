...
function RandomTheme({ className, onThemeChange }: RandomThemeProps) {
  ...
  return (
    <div className={`flex flex-col justify-center ${className || ''}`}>
      <div
        className="shuffle-btn w-10 h-10 flex justify-center items-center shadow-xl shadow-gray-100 p-2 bg-indigo-400 hover:bg-indigo-500 rounded-xl cursor-pointer text-white text-2xl"
        onClick={changeTheme}
      >
        <SvgIcon name="random" />
      </div>
